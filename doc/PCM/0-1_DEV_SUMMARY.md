...
- [x] **建構 Phase 13**: 建立主計畫 `047` 與詳細子計畫 `048-051`。
...
- [ ] **Phase 13 (待啟動)**: 全球智力與策略演化 (18 核心評分與 26 基因透明化)。
...
- [x] **GitHub CI 前端修復**: 解決 Supabase 鏈式調用 Mock 失敗、SWR 測試隔離不足與 UI 斷言不匹配 (TC-1201~4102)。
