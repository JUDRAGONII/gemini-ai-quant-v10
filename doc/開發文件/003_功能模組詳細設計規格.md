...
##### 1. 美國宏觀指標清單 (基於 FRED API)
*   **利率與貨幣政策**: FEDFUNDS (日), DGS10 (日), DGS2 (日), DGS5 (日), DGS30 (日), DTB3 (日), M2SL (週), RESBALNS (週)。
*   **通貨膨脹**: CPIAUCSL (月), CPILFESL (月), PCECTPI (月), PCEPILFE (月), WPUINDEX (月), T10YIE (日), T5YIE (日)。
*   **就業與勞動**: UNRATE (月), PAYEMS (月), ICSA (週), CCSA (週), CES0500000003 (月), JOLTS (月)。
*   **經濟成長**: GDP (季), GDPC1 (季), PCE (季), GPDI (季), IPMAN (月), RSXFS (月), HOUST (月)。
*   **信心指數**: UMICHCSI (月), NAPM (月), NYFSBR (月), PHFSBR (月)。
*   **風險指標**: VIXCLS (日), BAA10Y (日)。

##### 2. 台灣宏觀指標清單 (政府 OpenAPI)
*   **景氣循環**: 景氣對策信號, 領先/同時/落後指標 (月)。
*   **國民所得**: GDP 季增/年增率, 各構成要素 (季)。
*   **物價**: CPI 年增率, CPI 分類指數, PPI (月)。
*   **勞動市場**: 失業率, 就業人數, 薪資統計 (月)。
*   **貨幣與匯率**: M1A/M1B/M2 (月), 美/日/歐/人對台幣匯率 (日)。
*   **貿易**: 進出口統計, 外銷訂單 (月)。
