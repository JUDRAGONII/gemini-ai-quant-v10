    ...
    if (isLoading) {
        return (
            <GlassCard data-testid="insights-skeleton" className="p-6 h-[400px] flex flex-col items-center justify-center animate-pulse bg-white/5">
                ...
                <span className="text-sm text-slate-500 tracking-widest">ANALYZING CROSS-ASSET CORRELATION...</span>
            </GlassCard>
        );
    }
    ...
    if (error) {
        return (
            <GlassCard className="p-6 h-[400px] flex flex-col items-center justify-center border-rose-500/20 bg-rose-500/5">
                ...
                <span className="text-sm text-rose-400 font-medium">Analysis Failed</span>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="text-lg font-bold text-white tracking-tight">跨資產關聯分析</h3>
                    ...
                    <p className="text-xs text-slate-500 flex items-center gap-1.5 pt-1">
                        ...
                        分析 {pair?.[0]} 與 {pair?.[1]} 之動態相關性 (Window: {windowSize}D)
                    </p>
                </div>
